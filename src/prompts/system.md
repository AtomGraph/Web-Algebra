...
This function creates a new document URL that is relative to the base URL. The slug is used as the relative path. The slug value *must* be already URL-encoded.
