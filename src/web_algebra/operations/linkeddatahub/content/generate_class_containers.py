...
class GenerateClassContainers(Operation):
    ...
    4. Adds an object block to surface the view in the item
    ...
    def inputSchema(cls) -> dict:
        return {
            ...
            "properties": {
                ...
                "parent_container": {
                    "type": "string",
                    "description": "URI of the parent container where class items will be created"
                },
                "endpoint": {
                    "type": "string",
                ...
                "service_uri": {
                    "type": "string",
                    "description": "URI of the global SPARQL service resource to reference in queries and views"
                }
            },
